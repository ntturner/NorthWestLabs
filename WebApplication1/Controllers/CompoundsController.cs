...
namespace WebApplication1.Controllers
{
    public class CompoundsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LTNumber,CompoundName")] Compound compound)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LTNumber,CompoundName")] Compound compound)
        {
            if (ModelState.IsValid)
            {
